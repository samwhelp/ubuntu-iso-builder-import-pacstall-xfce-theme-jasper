...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-xfce-theme-jasper"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-xfce-theme-jasper/iso-profile
"
echo
